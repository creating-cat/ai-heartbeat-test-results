...
6. [行動原則三箇条](#6-行動原則三箇条)
7. [ブロッカー発生時の対応](#7-ブロッカー発生時の対応)
8. [詳細情報リソース](#8-詳細情報リソース)
...
**ブロッカーとは**: 現在の作業の進行を完全に停止させる、あるいは著しく妨げる障害や問題のことです。

**必須**: ブロッカー発生時は、再試行を行う前に必ず`./ai-docs/ERROR_HANDLING.md` を読み込んでその内容に従い対応してください。
